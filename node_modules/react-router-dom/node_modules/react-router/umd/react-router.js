(function (global, factory) {
  ...
  */
  ...
  var InnerPrompt = function (_React$Component) {
    inherits(InnerPrompt, _React$Component);

    function InnerPrompt() {
      classCallCheck(this, InnerPrompt);
  ...
  var Prompt = function Prompt(props) {
    return React.createElement(
      ...
      function (_ref) {
        ...
        return React.createElement(InnerPrompt, _extends$4({}, props, { router: router }));
      }
    );
  };
  ...
  var InnerRedirect = function (_React$Component) {
    inherits(InnerRedirect, _React$Component);

    function InnerRedirect() {
      classCallCheck(this, InnerRedirect);
      return possibleConstructorReturn(this, _React$Component.apply(this, arguments));
    }
  ...
  var Redirect = function Redirect(props) {
    return React.createElement(
      ...
      function (_ref2) {
        ...
        return React.createElement(InnerRedirect, _extends$4({}, props, { router: router }));
      }
    );
  };
  ...
  var InnerRoute = function (_React$Component) {
    inherits(InnerRoute, _React$Component);

    function InnerRoute() {
      var _temp, _this, _ret;

      classCallCheck(this, InnerRoute);
  ...
  var Route = function Route(props) {
    return React.createElement(
      ...
      function (_ref2) {
        var router = _ref2.router;
        return React.createElement(InnerRoute, _extends$4({}, props, { router: router }));
      }
    );
  };
  ...
  var InnerSwitch = function (_React$Component) {
    inherits(InnerSwitch, _React$Component);

    function InnerSwitch() {
      classCallCheck(this, InnerSwitch);
      return possibleConstructorReturn(this, _React$Component.apply(this, arguments));
    }
  ...
  var Switch = function Switch(props) {
    return React.createElement(
      ...
      function (_ref) {
        var router = _ref.router;
        return React.createElement(InnerSwitch, _extends$4({}, props, { router: router }));
      }
    );
  };
