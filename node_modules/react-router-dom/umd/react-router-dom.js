  ...
  */
  ...
  var Router = function (_React$Component) {
    ...
    Router.prototype.getChildContext = function getChildContext() {
      return {
        router: _extends$4({}, this.props.router, {
    ...
    Router.prototype.render = function render() {
      ...
      return React.createElement(RouterContext.Provider, { value: this.getChildContext() }, children ? React.Children.only(children) : null);
    };
  ...
  var Link = function (_React$Component) {
    ...
    function Link() {
      ...
      return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleClick = function (history) {
    ...
    Link.prototype.render = function render() {
      ...
      return React.createElement(
        ...
        function (_ref) {
          ...
          invariant_1$1(router, "You should not use <Link> outside a <Router>");
          ...
          return React.createElement("a", _extends$5({}, props, {
  ...
  var InnerRoute = function (_React$Component) {
    _inherits$2(InnerRoute, _React$Component);

    function InnerRoute() {
      var _temp, _this, _ret;

      _classCallCheck$2(this, InnerRoute);
    ...
    InnerRoute.prototype.getChildContext = function getChildContext() {
      return {
        router: _extends$6({}, this.props.router, {
          route: {
    ...
    InnerRoute.prototype.render = function render() {
      return React.createElement(RouterContext.Provider, { value: this.getChildContext() }, this.renderChildren());
    };
  ...
  var Route = function Route(props) {
    return React.createElement(RouterContext.Consumer, null, function (_ref2) {
      var router = _ref2.router;
      return React.createElement(InnerRoute, _extends$6({}, props, { router: router }));
    });
  };
  ...
  var InnerPrompt = function (_React$Component) {
    _inherits$3(InnerPrompt, _React$Component);

    function InnerPrompt() {
      _classCallCheck$3(this, InnerPrompt);
    ...
    InnerPrompt.prototype.componentWillMount = function componentWillMount() {
      invariant_1$1(this.props.router, "You should not use <Prompt> outside a <Router>");
  ...
  var Prompt = function Prompt(props) {
    return React.createElement(RouterContext.Consumer, null, function (_ref) {
      var router = _ref.router;
      return React.createElement(InnerPrompt, _extends$7({}, props, { router: router }));
    });
  };
  ...
  var InnerRedirect = function (_React$Component) {
    _inherits$4(InnerRedirect, _React$Component);

    function InnerRedirect() {
      _classCallCheck$4(this, InnerRedirect);
    ...
    InnerRedirect.prototype.componentWillMount = function componentWillMount() {
      invariant_1$1(this.props.router, "You should not use <Redirect> outside a <Router>");
  ...
  var Redirect = function Redirect(props) {
    return React.createElement(RouterContext.Consumer, null, function (_ref2) {
      var router = _ref2.router;
      return React.createElement(InnerRedirect, _extends$8({}, props, { router: router }));
    });
  };
  ...
  var StaticRouter = function (_React$Component) {
    ...
    StaticRouter.prototype.render = function render() {
      ...
      return React.createElement(Router, _extends$9({}, props, {
        history: history,
  ...
  var InnerSwitch = function (_React$Component) {
    _inherits$6(InnerSwitch, _React$Component);

    function InnerSwitch() {
      _classCallCheck$6(this, InnerSwitch);

      return _possibleConstructorReturn$6(this, _React$Component.apply(this, arguments));
    }

    InnerSwitch.prototype.componentWillMount = function componentWillMount() {
      invariant_1$1(this.props.router, "You should not use <Switch> outside a <Router>");
    };

    InnerSwitch.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    InnerSwitch.prototype.render = function render() {
  ...
  var Switch = function Switch(props) {
    return React.createElement(RouterContext.Consumer, null, function (_ref) {
      var router = _ref.router;
      return React.createElement(InnerSwitch, _extends$a({}, props, { router: router }));
    });
  };
