  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.style = function () {
        return (0, _emotion.css)('{width:0;height:0;border-left:', _this.props.size + _this.props.sizeUnit, ' solid transparent;border-right:', _this.props.size + _this.props.sizeUnit, ' solid transparent;border-bottom:', _this.props.size + _this.props.sizeUnit, ' solid ', _this.props.color, ';display:inline-block;animation:', skew, ' 3s 0s infinite cubic-bezier(.09,.57,.49,.9);animation-fill-mode:both;}');
