...
doneWithPref(recieveResults) { 
  ...
  render() {
    ...
    // As long as no results are loaded, it will keep displaying the location page
      ...
      return (<Preferences allUsers={this.props.allUsers} doneWithPref= {this.doneWithPref.bind(this)} logout= {this.props.logout} groupCode={this.props.groupCode} userInGroup={this.props.userInGroup} DisplayResults={currentComponent.display.bind(this)}/> )
    }
    else{
